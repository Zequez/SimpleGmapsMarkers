...
;
  ...
  var $, Marker, SimpleGmapsMarker;

  $ = jQuery;

  SimpleGmapsMarker = (function() {

    function SimpleGmapsMarker(element, options) {
    ...
    SimpleGmapsMarker.prototype.findElements = function() {
      this.element = $(this.element);
      return this.markers_elements = this.element.find('.simple-gmaps-marker').remove();
    };

    SimpleGmapsMarker.prototype.buildMarkers = function() {
      var marker, marker_element;
      return this.markers = (function() {
        var _fn, _i, _len, _ref, _results,
          _this = this;
        _ref = this.markers_elements;
        _fn = function(marker) {
          return marker.onClick(function() {
            var mark, _j, _len1, _ref1;
            _ref1 = _this.markers;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          marker_element = _ref[_i];
          marker = new Marker($(marker_element), this.gmap);
          _fn(marker);
    ...
    SimpleGmapsMarker.prototype.buildGmap = function() {
      return this.gmap = new google.maps.Map(this.element[0], this.gmapOptions());
    };

    SimpleGmapsMarker.prototype.gmapOptions = function() {
      return {
    ...
    SimpleGmapsMarker.prototype.bounds = function() {
      var _this = this;
      return this._bounds || (this._bounds = (function() {
    ...
    SimpleGmapsMarker.prototype.fitMap = function() {
      var listener,
        _this = this;
      this.gmap.fitBounds(this.bounds());
      console.log(this.gmap.getZoom());
      return listener = google.maps.event.addListener(this.gmap, "idle", function() {
        if (_this.gmap.getZoom() > 14) {
          _this.gmap.setZoom(14);
        }
        return google.maps.event.removeListener(listener);
      });
    };

    return SimpleGmapsMarker;

  })();

  Marker = (function() {

    function Marker(element, gmap) {
      this.element = element;
      this.gmap = gmap;
      this.buildMarker();
      this.buildInfobox();
    ...
    Marker.prototype.onClick = function(callbackClick) {
      this.callbackClick = callbackClick;
    };

    Marker.prototype.buildMarker = function() {
      return this.marker = new google.maps.Marker(this.markerOptions());
    };

    Marker.prototype.markerOptions = function() {
      return {
        map: this.gmap,
    ...
    Marker.prototype.latlng = function() {
      return this._latlng || (this._latlng = new google.maps.LatLng(this.lat(), this.lng()));
    };

    Marker.prototype.lat = function() {
      return parseFloat(this.element.attr('data-lat'));
    };

    Marker.prototype.lng = function() {
      return parseFloat(this.element.attr('data-lng'));
    };

    Marker.prototype.buildInfobox = function() {
      this.infobox = new InfoBox(this.infoboxOptions());
      return this.infobox.open(this.gmap, this.marker);
    };

    Marker.prototype.infoboxOptions = function() {
      return {
    ...
    Marker.prototype.bindInfobox = function() {
      var _this = this;
      return google.maps.event.addDomListener(this.element[0], 'click', function() {
        if (_this.callbackClick) {
          return _this.callbackClick();
        }
      });
    };
  ...
  $.fn.extend({
    simpleGmapsMarker: function(options) {
      return this.each(function() {
        return $(this).data('simpleGmapsMarker', new SimpleGmapsMarker(this, options));
      });
    }
  });
