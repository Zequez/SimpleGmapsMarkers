...
;
  ...
  var $, Marker, SimpleGmapsMarkers;

  $ = jQuery;

  SimpleGmapsMarkers = (function() {

    function SimpleGmapsMarkers(element, options) {
    ...
    SimpleGmapsMarkers.prototype.buildGmap = function() {
      return this.gmap = new google.maps.Map(this.element[0], this.gmapOptions());
    };

    SimpleGmapsMarkers.prototype.gmapOptions = function() {
      return {
    ...
    SimpleGmapsMarkers.prototype.bounds = function() {
      var _this = this;
    ...
    SimpleGmapsMarkers.prototype.fitMap = function() {
      var listener,
        _this = this;
  ...
  $.fn.extend({
    simpleGmapsMarkers: function(options) {
      return this.each(function() {
        return $(this).data('simpleGmapsMarkers', new SimpleGmapsMarkers(this, options));
      });
    }
  });

  $(function() {
    return $('.simple-gmaps').simpleGmapsMarkers();
  });
